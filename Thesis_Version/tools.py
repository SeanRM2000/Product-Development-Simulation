    ...
    def load_data(self, tool_data, architecture):
        for name, details in tool_data.items():
            ...
            if details['type'] == 'knowledgebase':
                ...
                self.knowledge_base['product_information_completeness'] = {}
                self.knowledge_base['product_information_consitency'] = {}
                for node, data in sorted(list(architecture.nodes(data=True))):
                    ...
                    self.knowledge_base['product_information_completeness'][node] = 0
                    self.knowledge_base['product_information_consitency'][node] = 0
