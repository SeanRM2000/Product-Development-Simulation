...
if __name__ == "__main__":
    ...
    activity_network = ActivityNetwork(architecture_graph, tools, org=org_graph, folder=folder, random_seed=42)

    
    task_network = TaskNetwork(activity_network, architecture_graph, randomize_structure=False, randomize_task_times=False)
