...
class ArchitectureGraph:
    ...
    def _add_element(self, name, knowledge_req, req_importance, novelty, prototype_start_condition):
        self.architecture.add_node(name,
                                   ...
                                   previous_perceived_definition_quality=0,
                                   perceived_definition_quality=0,      ####### perceived definition not needed
                                   previous_design_quality=0,
                                   design_quality=0,
                                   previous_perceived_design_quality=0,
                                   perceived_design_quality=0,
                                   simulation_result=0, ### hf, lf???
                                   testing_result=0,
                                   previous_overall_quality=0, ##### indlude testing and simulation results instead of perceived quality
                                   overall_quality=0,
                                   previous_perceived_overall_quality=0,
    ...
    def _add_interface_dependency(self, node1_name, node2_name, interface_severity):
        ...
        self.architecture.add_edge(node1_name, node2_name, 
                    ...
                    definition_quality=0,
                    previous_perceived_definition_quality=0,
                    perceived_definition_quality=0,            ######################### might not be needed
                    previous_design_quality=0,
                    design_quality=0,
                    previous_perceived_design_quality=0,
                    perceived_design_quality=0
